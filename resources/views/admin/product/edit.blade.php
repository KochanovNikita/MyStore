            ...
            <div class="row">
                <div class="col-12 col-lg-6 col-xl-4">
                    <div class="mb-3">
                        ...
                        value="{{ old('title') ? old('title') : $product->title }}" class="form-control">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        value="{{ old('price') ? old('price') : $product->price }}" class="form-control">
                    </div>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="form-group clearfix">
                            ...
                            <div class="icheck-primary d-inline">
                                ...
                                value="{{$color->id}}"
                                name="color_id"
                                {{$product->color_id == $color->id ? 'checked' : ''}}
                                >
                            ...
                            <div class="form-group mb-3 clearfix d-none" id="subCategoriesGroup{{$category->id}}">
                                @foreach ($category->subcategories as $subcategory)
                                    <div class="icheck-primary d-inline">
                                        ...
                                        name="subcategories[]"
                                        @foreach ($product->subcategories as $prsc)
                                            {{$prsc->id == $subcategory->id ? 'checked' : ''}}
                                        @endforeach
